...
void BasebandSignalSegment::setSignalMatrix(const SignalMatrix<std::complex<int32_t>> &bbsignalsV) {
    bbsignalsInt32 = bbsignalsV;
    setSegmentPayload(bbsignalsInt32.toBuffer());
}
